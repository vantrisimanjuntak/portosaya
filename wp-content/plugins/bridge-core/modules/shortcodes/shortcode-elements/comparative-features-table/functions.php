...
if( ! function_exists('bridge_core_comparative_features_table_wpml_wpb_decode_urlencoded_json') ) {
	function bridge_core_comparative_features_table_wpml_wpb_decode_urlencoded_json( $string, $encoding, $original_string ) {
	...
	add_filter( 'wpml_pb_shortcode_decode', 'bridge_core_comparative_features_table_wpml_wpb_decode_urlencoded_json', 10, 3 );
}
