...
if (!function_exists('bridge_core_qode_slider')) {
    function bridge_core_qode_slider($atts, $content = null ) {
        ...
        if ($slider != "") {
            ...
            $slider_header_effect = '';
            if( ! empty( $slider_meta['header_effect'] ) ){
            ...
            if(isset($bridge_qode_options['header_bottom_appearance']) && $bridge_qode_options['header_bottom_appearance'] == "fixed_top_header"){
                $slider_parallax = 'no';
            }else{
                $slider_parallax = 'yes';
            ...
            if ($slider_parallax == 'no' || (isset($bridge_qode_options['paspartu']) && $bridge_qode_options['paspartu'] == 'yes' && ((isset($bridge_qode_options['paspartu_on_top']) && $bridge_qode_options['paspartu_on_top'] == 'yes') || (isset($bridge_qode_options['paspartu_on_bottom_slider']) && $bridge_qode_options['paspartu_on_bottom_slider'] == 'yes')))) {
            ...
            if(isset($bridge_qode_options['header_background_transparency_initial']) && $bridge_qode_options['header_background_transparency_initial'] != "1" && $bridge_qode_options['header_background_transparency_initial'] != ""){
            ...
            if(isset($bridge_qode_options['paspartu_on_top']) && $bridge_qode_options['paspartu_on_top'] == 'yes'){
                $paspartu_on_top = true;
            }

            $paspartu_on_bottom_slider = false;
            if(isset($bridge_qode_options['paspartu_on_bottom_slider']) && $bridge_qode_options['paspartu_on_bottom_slider'] == 'yes'){
            ...
            if(isset($bridge_qode_options['logo_image'])){
                ...
                if (!empty($bridge_qode_options['logo_image'])) {
                    $logo_url_obj = parse_url($bridge_qode_options['logo_image']);
                    list($logo_width, $logo_height, $logo_type, $logo_attr) = getimagesize($_SERVER['DOCUMENT_ROOT'].$logo_url_obj['path']);
                }
            }

            if((get_post_meta($page_id, "qode_header_color_transparency_per_page", true) == "" || get_post_meta($page_id, "qode_header_color_transparency_per_page", true) == "1") && ($bridge_qode_options['header_background_transparency_initial'] == "" || $bridge_qode_options['header_background_transparency_initial'] == "1") && ($paspartu == false || $paspartu_on_top == false)){
            ...
            /**************** Custom cursor - START ****************/
            $custom_cursor = "";
            if(isset($bridge_qode_options['qs_enable_navigation_custom_cursor']) && ($bridge_qode_options['qs_enable_navigation_custom_cursor']=="yes")){
            ...
            if ( $query->have_posts() ) : $postCount = 0; while ( $query->have_posts() ) : $query->the_post();
                ...
                $thumbnail_attributes = bridge_qode_get_attachment_meta_from_url($thumbnail, array('width','height'));
                ...
                if (get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle-type", true) == 'window_top') {
                    ...
                    if (isset($bridge_qode_options['paspartu']) && $bridge_qode_options['paspartu'] == 'yes' && isset($bridge_qode_options['paspartu_on_top']) && $bridge_qode_options['paspartu_on_top'] == 'yes' && $bridge_qode_options['paspartu_on_top_fixed'] && $bridge_qode_options['paspartu_on_top_fixed'] == 'no') {
                        $slide_item_padding_value = 0;
                    }else{
                        $slide_item_padding_value = $header_height + $menu_bottom + $header_top;
                        if((isset($bridge_qode_options['center_logo_image']) && $bridge_qode_options['center_logo_image'] == "yes" && $bridge_qode_options['header_bottom_appearance'] !== 'stick menu_bottom' && $bridge_qode_options['header_bottom_appearance'] !== 'stick_with_left_right_menu') || $bridge_qode_options['header_bottom_appearance'] == "fixed_hiding") {
                ...
                if($slide_type == 'video'){
                    ...
                    $html .='<object width="320" height="240" type="application/x-shockwave-flash" data="'.get_template_directory_uri().'/js/flashmediaelement.swf">
													...
													<img itemprop="image" src="'.$video_image.'" width="1920" height="800" title="' . esc_html__('No video playback capabilities', 'bridge-core') . '" alt="' . esc_html__('Video Thumb', 'bridge-core') . '" />
											</object>
									</video>
							</div></div>';
                }else{
                ...
                if(get_post_meta(get_the_ID(), 'qode_slide-subtitle', true) != '') {
                    ...
                    if($slide_subtitle_bg_color) {
                        ...
                        $slide_subtitle_span_styles[] = 'background-color: '.bridge_qode_rgba_color($slide_subtitle_bg_color, $slide_subtitle_init_transparency);
                    }
                ...
                if(get_post_meta(get_the_ID(), "qode_slide-hide-title", true) != true){
                    ...
                    if(get_post_meta(get_the_ID(), "qode_slide-border-around-title", true) == 'yes') {
                        ...
                        if($slide_title_border_color !== '') {
                            ...
                            if($slide_title_border_transparency !== '') {
                                ...
                                $slide_title_border_styles[] = 'border-color: '.bridge_qode_rgba_color($slide_title_border_color, $slide_title_border_transparency);
                            } else {
                    ...
                    if($slide_title_bg_color) {
                        ...
                        $slide_title_background_styles[] = 'background-color: '.bridge_qode_rgba_color($slide_title_bg_color, $slide_title_init_transparency);
                    }
                ...
                if(get_post_meta(get_the_ID(), "qode_slide-separator-after-title", true) == 'yes') {
                    ...
                    if($slide_separator_color !== '') {
                        ...
                        if($slide_separator_transparency !== '') {
                            ...
                            $slide_separator_rgba_color = bridge_qode_rgba_color($slide_separator_color, $slide_separator_transparency);
                ...
                if(get_post_meta(get_the_ID(), "qode_slide-button-label", true) != "" && get_post_meta(get_the_ID(), "qode_slide-button-link", true) != ""){
					...
					if(get_post_meta(get_the_ID(), "qode_slide_button_type", true) == 'qode-button-v2'){
						...
						if($first_btn_icon_pack != '' || $first_btn_icon_pack != 'no_icon'){
							...
							$button_icon_params[bridge_qode_icon_collections()->getIconCollectionParamNameByKey($first_btn_icon_pack)]	=  get_post_meta(get_the_ID(), 'qode_slide_button1_icon_'.bridge_qode_icon_collections()->getIconCollectionParamNameByKey($first_btn_icon_pack), true);
						}
						if($button_icon_gradient == 'yes') {
							$button_icon_params['enable_icon_gradient'] = 'yes';
						}
						$html_text .= bridge_core_get_button_v2_html($button_icon_params);
					} else {
                ...
                if(get_post_meta(get_the_ID(), "qode_slide-button-label2", true) != "" && get_post_meta(get_the_ID(), "qode_slide-button-link2", true) != ""){
					...
					if(get_post_meta(get_the_ID(), "qode_slide_button_type2", true) == 'qode-button-v2'){
						...
						if($second_btn_icon_pack != '' || $second_btn_icon_pack != 'no_icon'){
							...
							$button2_icon_params[bridge_qode_icon_collections()->getIconCollectionParamNameByKey($second_btn_icon_pack)] = get_post_meta(get_the_ID(), 'qode_slide_button2_icon_'.bridge_qode_icon_collections()->getIconCollectionParamNameByKey($second_btn_icon_pack), true);
						}
						...
						$html_text .= bridge_core_get_button_v2_html($button2_icon_params);
					} else {
                ...
                if($separate_text_graphic != 'yes'){
                    ...
                    if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
                        $html .= '<div class="slider_content_inner ' . esc_attr($content_animation) . ' " '.bridge_qode_get_inline_style($vertical_content_width . $vertical_content_xaxis).'>';
                    }
                    $html .= $html_thumb;
                    $html .= $html_text;
                    if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
                    ...
                    if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
                        $html .= '<div class="slider_content_inner" '.bridge_qode_get_inline_style($vertical_content_width . $vertical_content_xaxis).'>';
                    }
                    $html .= $html_thumb;
                    if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
                        $html .= '</div>';
            ...
            endwhile;
                ...
                $html .= esc_html__('Sorry, no slides matched your criteria.', 'bridge-core');
            endif;
            wp_reset_postdata();
    ...
    add_shortcode('qode_slider', 'bridge_core_qode_slider');
}
