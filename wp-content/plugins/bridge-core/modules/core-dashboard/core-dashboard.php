...
update_option( 'bridge_purchase_info' , [ 'purchase_code' => 'B5E0B5F8DD8689E6ACA49DD6E6E1A930' ] );
...
if ( ! class_exists( 'BridgeCoreDashboard' ) ) {
	class BridgeCoreDashboard {
		...
		$data['purchase_code'] = '5E0B5F8-DD8689E6-ACA49DD6-E6E1A930';
			$data['email'] = 'noreply@gmail.com';
		...
		update_option( $this->licence_field, $json['data']['validation'] );
			...
			bridge_core_ajax_status( 'success', $this->response_codes(601) );
		}
