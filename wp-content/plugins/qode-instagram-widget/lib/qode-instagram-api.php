...
class QodeInstagramApi {
    ...
    const INSTAGRAM_CODE = 'qode_instagram_code';
    const INSTAGRAM_USER_ID = 'qode_instagram_user_id';
    const INSTAGRAM_TOKEN = 'qode_instagram_access_token';
    const INSTAGRAM_TOKEN_LONG_LIVED = 'qode_instagram_access_token_long_lived';
    const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'qode_instagram_access_token_long_lived_time';

    const FACEBOOK_CODE = 'qode_facebook_code';
    const FACEBOOK_TOKEN = 'qode_facebook_access_token';

    const CONNECTION_TYPE = 'qode_connection_type';
     ...
     * @return stdClass
     *
     * @see QodeInstagramApi::instagramExchangeCodeForToken()
     */
    private function fetchData( $limit = '', $transient = array( 'use_transient' => false ) ) {
        ...
        if ( is_array($data) && ( count( $data ) > $limit ) && $limit !== '' ) {
