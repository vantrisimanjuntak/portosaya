...
if ( $row_gap ) {
	$css_custom .= $id_recent_posts . ' ul.side-newsfeed:not(.penci-feed-2columns) li{ margin-bottom: ' . $row_gap . '; padding-bottom: ' . $row_gap . '; }';
	$css_custom .= $id_recent_posts . ' ul.penci-feed-2columns li{ margin-bottom: ' . $row_gap . ';}';
}
