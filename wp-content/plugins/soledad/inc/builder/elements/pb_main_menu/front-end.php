<?php
$menu_id = penci_get_builder_mod( 'penci_header_pb_main_menu_name' );
if ( is_page() ) {
...
$classes[] = penci_get_builder_mod( 'penci_header_pb_main_menu_class', 'no-class' );
$classes[] = 'disable' == penci_get_builder_mod( 'penci_header_pb_main_menu_penci_header_enable_padding' ) ? 'menu-item-normal' : 'menu-item-padding';
$classes[] = 'enable' == penci_get_builder_mod( 'penci_header_pb_main_menu_penci_header_remove_line_hover' ) ? 'pcremove-lineh' : '';
