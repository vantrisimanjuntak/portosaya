<?php
$menu_id = penci_get_builder_mod( 'penci_header_pb_second_menu_name' );
if ( is_page() ) {
...
$classes[] = penci_get_builder_mod( 'penci_header_pb_second_menu_class', 'no-class' );
$classes[] = 'enable' == penci_get_builder_mod( 'penci_header_pb_second_menu_penci_header_enable_padding' ) ? 'menu-item-padding' : 'menu-item-normal';
$classes[] = 'enable' == penci_get_builder_mod( 'penci_header_pb_second_menu_penci_header_remove_line_hover' ) ? 'pcremove-lineh' : '';
