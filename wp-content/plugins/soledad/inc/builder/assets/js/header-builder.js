!function (e, n) {
    ...
    n((function () {
        t.on("penci-open-header-builder", l), n(".top-menu.close").on("click", (function () {
            ...
            t.appendTo(i), v(a)
        })), s(), n(".header-setting").on("mousedown", (function () {
            var e = n(this).parents(".header-builder-column");
            e.hasClass("active") ? e.removeClass("active") : (n(".header-builder-column").removeClass("active"), e.addClass("active"))
        })), t.on("mousedown", (function (e) {
            var t = n(e.target),
                a = t.parents(".header-column-option-tooltip"),
                i = t.parents(".header-setting"),
                o = t.hasClass("header-setting");
            0 !== a.length || 0 !== i.length || o || n(".header-builder-column").removeClass("active")
        })), n("#customize-header-actions").append("<div class='penci-btn-header-builder'><i class='fa fa-bars'></i></div>"), n(".penci-btn-header-builder").on("click", (function () {
