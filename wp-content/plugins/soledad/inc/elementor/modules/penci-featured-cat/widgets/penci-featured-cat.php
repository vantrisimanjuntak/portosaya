...
class PenciFeaturedCat extends Base_Widget {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'cat_rmborder_bottom', array(
				'label'     => __( 'Remove Border Bottom Between Post Items', 'soledad' ),
				'type'      => Controls_Manager::SWITCHER,
				'selectors'          => array(
					'{{WRAPPER}} .home-featured-cat-content .mag-post-box' => 'border-bottom: none; margin-bottom: 20px; padding-bottom: 0;',
					'{{WRAPPER}} .home-featured-cat-content.style-2 .mag-post-box.first-post, {{WRAPPER}} .home-featured-cat-content.style-10 .mag-post-box.first-post, {{WRAPPER}} .home-featured-cat-content.style-8 .penci-grid li.list-post'  => 'padding-bottom: 0; border-bottom: none;',
		...
		$this->add_control(
			'pborder_color',
			array(
				'label'     => __( 'Borders Color Between Post Items', 'soledad' ),
				'type'      => Controls_Manager::COLOR,
