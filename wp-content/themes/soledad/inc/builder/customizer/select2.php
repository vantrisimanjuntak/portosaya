...
class Penci_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'penci-select2-js', get_template_directory_uri() . '/inc/customizer/js/select2.full.min.js', array( 'jquery' ), PENCI_SOLEDAD_VERSION, true );
		...
		wp_enqueue_style( 'penci-select2-css', get_template_directory_uri() . '/inc/customizer/css/select2.min.css', array(), PENCI_SOLEDAD_VERSION, 'all' );
	}
