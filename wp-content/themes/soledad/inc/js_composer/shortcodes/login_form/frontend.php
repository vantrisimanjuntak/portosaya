...
if ( $form_button_color ) {
	$css_custom .= $id_login_form . '.penci-login-register input[type="submit"], '. $id_login_form .' .penci-user-logged-in .penci-user-action-links a{ color:' . esc_attr( $form_link_color ) . ' }';
}
if ( $form_button_bgcolor ) {
	$css_custom .= $id_login_form . '.penci-login-register input[type="submit"], '. $id_login_form .' .penci-user-logged-in .penci-user-action-links a{ border-color:' . esc_attr( $form_button_bgcolor ) . ';background-color:' . esc_attr( $form_button_bgcolor ) . ' }';
}
if ( $form_button_hcolor ) {
	$css_custom .= $id_login_form . '.penci-login-register input[type="submit"]:hover, '. $id_login_form .' .penci-user-logged-in .penci-user-action-links a:hover{ color:' . esc_attr( $form_button_hcolor ) . ' }';
}
if ( $form_button_hbgcolor ) {
	$css_custom .= $id_login_form . '.penci-login-register input[type="submit"]:hover, '. $id_login_form .' .penci-user-logged-in .penci-user-action-links a:hover{ border-color:' . esc_attr( $form_button_hbgcolor ) . ';background-color:' . esc_attr( $form_button_hbgcolor ) . ' }';
}
if ( $ploginregis_link ) {
