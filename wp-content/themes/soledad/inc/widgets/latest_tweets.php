...
if ( ! class_exists( 'penci_latest_tweets_widget' ) ) {
	class penci_latest_tweets_widget extends WP_Widget {
			...
			if ( ! empty( $tweets ) ):
				...
				if ( isset( $tweets['error'] ) ) {
                    ...
                    <div class="penci-tweets-widget-content <?php echo $align; ?>">
                        ...
                        <div class="penci-owl-carousel penci-owl-carousel-slider penci-tweets-slider" data-dots="true"
		...
		public function soledad_widget_defaults() {
			$defaults = array( 'title'    => esc_html__( 'Tweets', 'soledad' ),
			                   'date'     => false,
			                   'auto'     => false,
		...
		function form( $instance ) {
            ...
            <br>
            <p><span style="color: #ff0000;">Note Important:</span> To use this widget you need fill complete your
                twitter information <a
                        href="<?php echo admin_url( 'options-general.php?page=tdf_settings' ); ?>">here</a></p>
