		...
		public function install_plugins_page() {
			...
			<div class="tgmpa wrap">
				...
				<div class="penci-plugins-notice">
					...
					<p class="penci-dplugins"><span class="penci-notice-head">Penci Shortcodes & Performance:</span> <?php esc_html_e( 'You should activate this plugin. It provide some shortcodes inside the editor & language shortcodes to help you can build multiple languages website. You need this plugin to optimize your site speed also.', 'tgmpa' ); ?></p>
