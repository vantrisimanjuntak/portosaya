<div id="logo">
	...
	<a href="<?php echo $logo_url; ?>">
		<img class="penci-mainlogo penci-logo" src="<?php echo esc_url( $logo_src ); ?>" alt="<?php bloginfo( 'name' ); ?>" width="<?php echo penci_get_image_data_basedurl( $logo_src, 'w' ); ?>" height="<?php echo penci_get_image_data_basedurl( $logo_src, 'h' ); ?>" />
		<?php if( $header_trans ): ?>
			<img class="penci-mainlogo penci-logo-sticky" src="<?php echo esc_url( $logo_sticky ); ?>" alt="<?php bloginfo( 'name' ); ?>" width="<?php echo penci_get_image_data_basedurl( $logo_src, 'w' ); ?>" height="<?php echo penci_get_image_data_basedurl( $logo_src, 'h' ); ?>" />
		<?php endif; ?>
	</a>
	<?php
